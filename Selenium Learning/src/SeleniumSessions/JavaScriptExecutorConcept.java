...
//		FileUtils.copyFile(scrFile, new File("D:\\Screenshots\\For Companies.png"));
		...
		// generate alert
		 //generateAlert(driver, "There is an issue with For Companies button on Homepage page");
...
//		 System.out.println(getPageInnerText(driver));
		 ...
		 WebElement Aboutus = driver.findElement(By.linkText("Blog"));
		 
		 scrollIntoView(driver, Aboutus);
