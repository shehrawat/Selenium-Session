...
public class HtmlUnitDriverConcept {
	...
	public static void main(String[] args) {
		...
		//advantages:
		//1. testing is happening behind the scene - no browser is loaded
		//2. very fast - execution of the script - performance of the script
		//3. not suitable for action class - mousemovement, doubleclick and drag and drop
